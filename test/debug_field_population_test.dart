...
void main() {
  group('Debug Field Population Tests', () {
    ...
    testWidgets('debug field population from profile', (WidgetTester tester) async {
      // Setup mocks
      ...
      final latitudeController = tester.widget<TextFormField>(latitudeField).controller;
      ...
      final longitudeController = tester.widget<TextFormField>(longitudeField).controller;
      ...
      final birthPlaceController = tester.widget<TextFormField>(birthPlaceField).controller;
