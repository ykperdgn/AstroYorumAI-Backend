...
void main() {
  group('AuthScreen Widget Tests', () {
    ...
    testWidgets('should display sign in form by default',
    ...
    testWidgets('should toggle between sign in and sign up',
      ...
      await tester.pumpAndSettle(); // Assert
      expect(find.text('Hesap Oluştur'),
          findsNWidgets(2)); // AppBar title + button
    ...
    testWidgets('should have submit button enabled with valid data',
        (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should display forgot password dialog',
        (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(createTestWidget());
      ...
      expect(find.text('Şifre sıfırlamak için e-posta adresini girin'),
          findsOneWidget);
    });

    testWidgets('should show cloud sync information cards',
        (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(createTestWidget());
