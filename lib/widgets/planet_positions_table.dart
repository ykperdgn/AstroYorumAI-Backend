  ...
  Widget build(BuildContext context) {
    return Table(
      border: TableBorder.all(
          ...
          width: 0.5), // Kenarlık rengi ve kalınlığı ayarlandı
      ...
      children: [
        TableRow(
          decoration: BoxDecoration(
              color:
                  Colors.deepPurple[50]), // Başlık satırı rengi biraz daha açık
          children: const [
            Padding(
              padding: EdgeInsets.symmetric(
                  vertical: 10.0, horizontal: 8.0), // Dikey padding artırıldı
              child: Text('Gezegen',
                  style: TextStyle(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 8.0, horizontal: 8.0), // Hücre içi padding
                ...
                Padding(
                  ...
                  child:
                      Text(planet.sign, style: const TextStyle(fontSize: 14)),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 8.0, horizontal: 8.0),
