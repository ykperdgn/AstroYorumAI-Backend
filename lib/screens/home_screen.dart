...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadActiveProfile() async {
    ...
    if (_activeProfile != null) {
      try {
        ...
        const mockZodiacSign = 'Aries'; // This should be calculated from birth data
        ...
        if (mounted) {
          setState(() {          _todaysReading = reading;
          });
        }      } catch (e) {
  ...
  void _navigateToNotificationSettingsScreen() {
    ...
    if (_activeProfile != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PartnerManagementScreen(userId: _activeProfile!.id),
        ),
      );
    } else {
  ...
  void _navigateToHoraryQuestionScreen() {
    if (_activeProfile != null) {
      // Always use the Pro screen - it handles both Pro and standard users
      Navigator.push(
        context,
        MaterialPageRoute(
  ...
  void _showProUpgradeDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(        title: Row(
          children: [
        ...
        content: Column(
          ...
          children: [            const Text(
            ...
            const SizedBox(height: 16),            const Container(
        ...
        actions: [
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [                  if (_activeProfile != null) ...[                    Card(
                      child: Padding(
                        padding: const EdgeInsets.all(16.0),
                        child: Column(
                    ...
                    if (_todaysReading != null) ...[
                      Card(
                        elevation: 4,
                        shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(12))),                        child: Container(
                  ...
                  Container(
                    ...
                    child: OutlinedButton.icon(
                      icon: Icon(
                        Icons.auto_awesome,
                        color: _activeProfile?.isPro == true ? Colors.white : Colors.grey.shade600,
                      ),
                      label: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
